...
module.exports = { config: { name: "welcome", version: "2.1", author: "NTKhang + customized by ChatGPT", category: "events" },

langs: { en: { session1: "morning", session2: "noon", session3: "afternoon", session4: "evening", multiple1: "you", multiple2: "you guys", defaultWelcomeMessage: `🥰 𝙰𝚂𝚂𝙰𝙻𝙰𝙼𝚄𝙰𝙻𝙰𝙸𝙺𝚄𝙼 {userNameTag}, 𝚠𝚎𝚕𝚌𝚘𝚖𝚎 {multiple} 𝚃𝚘 𝙾𝚞𝚛 『{boxName}』 𝙶𝚛𝚘𝚞𝚙😊
• 𝙸 𝙷𝚘𝚙𝚎 𝚈𝚘𝚞 𝚆𝚒𝚕𝚕 𝙵𝚘𝚕𝚕𝚘𝚠 𝙾𝚞𝚛 𝙶𝚛𝚘𝚞𝚙 𝚁𝚞𝚕𝚎𝚜 • {prefix}rules 𝚏𝚘𝚛 𝙶𝚛𝚘𝚞𝚙 𝚁𝚞𝚕𝚎𝚜 • {prefix}help 𝙵𝚘𝚛 𝙰𝚕𝚕 𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜
• 𝚈𝚘𝚞 𝙰𝚛𝚎 𝚃𝚑𝚎 {memberIndex} 𝙼𝚎𝚖𝚋𝚎𝚛{memberPlural} 𝚒𝚗 𝙾𝚞𝚛 𝙶𝚛𝚘𝚞𝚙 • 𝙰𝚍𝚍𝚎𝚍 𝙱𝚢: {inviterName}` } },
...
global.temp.welcomeEvent[threadID].joinTimeout = setTimeout(async () => {
  ...
  try {
    ...
    inviterName = inviterInfo[inviterID]?.name || "Unknown";
    mentions.push({ tag: inviterName, id: inviterID });
  } catch {}

  const body = welcomeMsgTemplate
...
function getNumberSuffix(n) { const s = ["th", "st", "nd", "rd"]; const v = n % 100; return (s[(v - 20) % 10] || s[v] || s[0]); }
